...
import { RecordDataType, TableDataType, TableListQueryParams } from './data.d';
import {
    queryList,
    removeData,
    createData,
...
export interface StateType {
    ...
    updateData: Partial<RecordDataType>;
}
...
const StoreModel: ModuleType = {
    ...
    async createTableData({ commit }, payload: Pick<RecordDataType,  "id" |  "phone" |  "code" |  "expiredTime"> ) {
        try {
    ...
    async updateTableData({ commit }, payload: RecordDataType ) {
            try {
                const { id } = payload;
