...
import { ConfigDataType, TableDataType, TableListQueryParams } from './data.d';
import {
    queryList,
    removeData,
    createData,
...
const StoreModel: ModuleType = {
    ...
    async createTableData({ commit }, payload: Pick<ConfigDataType,  "id" |  "name" |  "platformType" |  "secretId" |  "status"> ) {
        try {
    ...
    async updateTableData({ commit }, payload: ConfigDataType ) {
            try {
                const { id } = payload;
